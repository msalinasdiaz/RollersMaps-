...
1. El propietario confirmó uxspa.cl y se comprobó acceso a DNS mediante cPanel. Falta elegir el proveedor y autenticar el remitente con sus registros.
...
## Estado al entregar
Preparación y evaluación terminadas. Dominio disponible: uxspa.cl. Acceso DNS comprobado en cPanel y panel publicado en https://rollersmaps-admin.uxspa.cl/. Pendientes para activar servicios: proveedor SMTP y remitente autenticado, proyecto Google Cloud con facturación y claves restringidas. Todavía no se cambió el proveedor de mapas ni la configuración de Auth. El siguiente paso es configurar el registro público, comprobarlo de extremo a extremo y luego integrar Google Maps.
