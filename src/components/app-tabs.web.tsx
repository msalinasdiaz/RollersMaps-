  ...
  return (
    <Tabs>
      ...
      <TabList style={styles.tabList}>
        ...
        <TabTrigger asChild href="/explore" name="explore"><TabButton>Rutas</TabButton></TabTrigger>
        <TabTrigger asChild href={'/my-activities' as never} name="my-activities"><TabButton>Mis actividades</TabButton></TabTrigger>
      </TabList>
    </Tabs>
  );
}
...
const styles = StyleSheet.create({
  slot: { height: '100%' },
  tabList: { alignItems: 'center', backgroundColor: '#101010', borderTopColor: '#2B2B2B', borderTopWidth: 1, bottom: 0, flexDirection: 'row', gap: 8, justifyContent: 'center', left: 0, padding: 10, position: 'absolute', right: 0 },
  tabButton: { alignItems: 'center', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 9 },
